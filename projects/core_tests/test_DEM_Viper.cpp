...
int main(int argc, char* argv[]) {
    ...
    viper.Initialize(ChFrame<>(ChVector<>(-0.9, -0.0, -0.17), QUNIT));
    ...
    float m_cm_cov = 1;
    // Define materials
    auto mat_type_terrain = DEMSim.LoadMaterial({{"E", 1e9 * kg_g_conv/m_cm_cov}, {"nu", 0.3}, {"CoR", 0.3}, {"mu", 0.5}, {"Crr", 0.0}});
